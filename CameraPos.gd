...
#	dir.z = self.translation.z;
	...
	yangle = lerp(yangle,-Input.get_action_strength("cam_yp") + Input.get_action_strength("cam_yn"),delta*0.7)
	xangle = lerp(xangle,-Input.get_action_strength("cam_xp") + Input.get_action_strength("cam_xn"),delta*0.7)
